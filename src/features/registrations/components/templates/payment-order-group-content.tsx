...
interface PaymentOrderGroupContentProps {
  formattedData: {
    ci: string;
    nombres: string;
    apellidos: string;
...
export const PaymentOrderGroupContent: React.FC<
  PaymentOrderGroupContentProps
> = ({ formattedData }) => {
  return (
    <>
      <img
        ...
        <tbody>
          <tr>
            <td className="w-1/3 border-b border-[#E0E0E0] px-2 py-3 body-sm text-onBack text-center">
              {formattedData.cantidadOlimpistas}
            </td>
            <td className="w-1/3 border-b border-[#E0E0E0] px-2 py-3 body-sm text-onBack text-center">
              Inscripciones
            </td>
