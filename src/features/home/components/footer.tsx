    ...
    <footer className="w-full bg-white border-t border-slate-200 py-5 text-onBack">
      <div className="max-w-screen-xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-center md:items-end gap-2">
          <p className="subtitle-md text-primary mb-1 text-left">Síguenos en:</p>
          <div className="flex gap-3">
            <ButtonIcon
              icon={() => <FaTiktok size={20} />}
              variantColor="variant2"
              onClick={() => window.open('https://www.tiktok.com/@ohsansi', '_blank')}
            />
            <ButtonIcon
              icon={() => <FaFacebook size={20} />}
              variantColor="variant2"
              onClick={() => window.open('https://www.facebook.com/people/Ohsansi/61560666333554/', '_blank')}
            />
            <ButtonIcon
              icon={() => <FaInstagram size={20} />}
              variantColor="variant2"
              onClick={() => window.open('https://www.instagram.com/ohsansi/', '_blank')}
            />
          </div>
        </div>
      </div>
