export const AREA_ERROR_MESSAGES = {
  ...
  PATTERN: 'Solo se permiten letras mayúsculas, guion en medio y un solo espacio entre palabras',
  ...
  VERIFY_ERROR: 'No se pudo verificar si el área ya existe. Intente nuevamente.'
};
