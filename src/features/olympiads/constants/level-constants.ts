export const LEVEL_ERROR_MESSAGES = {
    ...
    PATTERN: 'Solo se permiten letras, números, guiones en medio y un solo espacio entre palabras',
    ...
    VERIFY_ERROR: 'No se pudo verificar si el nivel ya existe. Intente nuevamente.'
  };
